...
class WinGUI(Tk):
    def __init__(self):
        ...
        # bug test
        self.tk_label_saturation = Label(self.tk_frame_container2, text="BUG", anchor="center", )
        self.tk_label_saturation.place(x=100, y=100, width=113, height=30)
        # self.tk_label_saturation = Label(self.tk_frame_container2, text="TEST", anchor="center", compound=self.ptbug)
        self.tk_label_saturation.place(x=100, y=100, width=113, height=30)
        self.tk_label_saturation = self.__tk_label_saturation(self.tk_frame_container2)
        # self.tk_scale_slider1 = Scale(self.tk_frame_container2, orient=HORIZONTAL, )
        # self.tk_scale_slider1.place(x=0, y=43, width=150, height=30)
    ...
    def __tk_label_saturation(self, parent):
        label = Label(parent, text="对比度调节", anchor="center", )  # 控件出现BUG
        # label.place(tkinter.LEFT,x=100, y=100, width=113, height=30)
    ...
    def __tk_label_exposure(self, parent):
        ...
        label.place(x=0, y=177, width=146, height=30)
        return label
    ...
    def __tk_label_saturation(self, parent):
        ...
        label.place(x=47, y=380, width=50, height=30)
        return label
