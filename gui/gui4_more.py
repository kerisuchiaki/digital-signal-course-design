...
class WinGUI(Tk):
    ...
    def __tk_tabs_option(self, parent):
        ...
        # frame.place(x=0, y=48, width=827, height=536)
    ...
    def __tk_button_rotate(self, parent):
        btn = Button(parent, text="旋转", takefocus=False, command=self.rotate_image)
    ...
    def __tk_scale_slider1(self, parent):
        ...
        scale.place(x=0, y=40, width=150, height=30)
        return scale

    def __tk_label_brightness(self, parent):
        label = Label(parent, text="亮度调节", anchor="center", )
        label.place(x=22, y=83, width=87, height=30)
        return label

    def __tk_label_saturation(self, parent):
        label = Label(parent, text="对比度调节", anchor="center", )
        label.place(x=0, y=0, width=113, height=30)
        return label
    ...
    def __tk_label_saturation(self, parent):
        ...
        label.place(x=47, y=380, width=80, height=30)
        return label
